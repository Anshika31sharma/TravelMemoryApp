    ...
    <main className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-earth-50 via-earth-100 to-earth-200">
      <PageTransition className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-earth-600 mt-2">Relive your journeys</p>
        </motion.div>
        ...
        >
          <h2 className="text-xl font-semibold text-earth-900 mb-6">Sign in</h2>
          ...
          <p className="mt-6 text-center text-earth-600 text-sm">
            ...
            <Link href="/signup" className="text-wander-teal font-medium hover:underline transition-opacity">
              Sign up
            </Link>
          </p>
        </motion.form>
